...
public class FileMain {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("파일여부 : " + dirObj.isFile()); System.out.println("존재여부 : "
		 * + dirObj.exists()); System.out.println("parent : " + dirObj.getParent());
		 * System.out.println("path : " + dirObj.getPath());
		 * 
		 * // File dirObj2 = new File("iotest/a/aaa"); File dirObj2 = new
		 * File("iotest/b/구름"); dirObj2.mkdirs();
		 * 
		 * System.out.println("------------------------");
		 * System.out.println(dirObj.getPath() + "정보");
		 * System.out.println("------------------------"); String[] list =
		 * dirObj.list(); for(String e : list) { System.out.println(e); }
		 */
	}
}